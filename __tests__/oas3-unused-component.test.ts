...
const remoteLocalDocument = new Document<any, any>(
  JSON.stringify(
    require("./__fixtures__/unusedShared/unusedComponentsSchema.remoteLocal.json")
  ),
  Parsers.Json,
  path.join(
    __dirname,
    "./__fixtures__/unusedShared/unusedComponentsSchema.remoteLocal.json"
  )
);
const definitionDocument = new Document<any, any>(
  JSON.stringify(
    require("./__fixtures__/unusedShared/unusedComponentsSchema.definition.json")
  ),
  Parsers.Json,
  path.join(
    __dirname,
    "./__fixtures__/unusedShared/unusedComponentsSchema.definition.json"
  )
);
const indirectDocument = new Document<any, any>(
  JSON.stringify(
    require("./__fixtures__/unusedShared/unusedComponentsSchema.indirect.1.json")
  ),
  Parsers.Json,
  path.join(
    __dirname,
    "./__fixtures__/unusedShared/unusedComponentsSchema.indirect.1.json"
  )
);
const indirect2Document = new Document<any, any>(
  JSON.stringify(
    require("./__fixtures__/unusedShared/unusedComponentsSchema.indirect.2.json")
  ),
  Parsers.Json,
  path.join(
    __dirname,
    "./__fixtures__/unusedShared/unusedComponentsSchema.indirect.2.json"
  )
);
